...
function NavigationMenu({ menu }) {
  ...
  return /* @__PURE__ */ React.createElement(React.Fragment, null, menu.map((item) => {
    ...
    return /* @__PURE__ */ React.createElement("li", {
      ...
      className: "flex rounded-lg px-3 py-2 text-slate-700 font-medium hover:bg-slate-100 hover:text-slate-900"
 ...
 */
//# sourceMappingURL=/build/_shared/chunk-72WDD35D.js.map
